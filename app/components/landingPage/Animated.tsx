...
export function AnimatedBeams() {
  ...
  return (
    <><div className=" flex justify-center pointer-events-none whitespace-pre-wrap bg-gradient-to-r from-pink-600 via-blue-600 to-purple-700 bg-clip-text text-center text-6xl font-semibold leading-none text-transparent mt-32 ">
      Integrate Your Essential Applications <br/>
      in a Centralized Platform {" "}
      🚀
    </div>
    <div className="relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg  bg-transparent p-10 md:shadow-xl"
          ref={containerRef}
      >
